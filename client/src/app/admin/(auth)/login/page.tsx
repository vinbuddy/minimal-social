...
export default function AdminLoginPage() {
    ...
    const onSubmitHandler = async (formData: IAdminLogin, e?: React.BaseSyntheticEvent): Promise<void> => {
        e?.preventDefault();
        ...
        try {
            ...
            showToast("Login to admin successfully", "success");
        } catch (error: any) {
        ...
        <div className="flex items-center justify-center py-12">
            <div className="mx-auto grid w-[350px] gap-6">
                <div className="grid gap-2 text-center">
                    ...
                    <p className="text-balance text-muted-foreground">Enter your admin credentials to log in</p>
                </div>
